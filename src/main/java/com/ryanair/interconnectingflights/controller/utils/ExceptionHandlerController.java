...
public class ExceptionHandlerController {
    ...
    public RestError handleBusinessRuleValidationError(
        ...
        if (exception instanceof BusinessException) {
            ...
            return new RoutesProviderError(routesProviderException.getMessageKey(), routesProviderException.getArguments());
            ...
            return new SchedulesProviderError(schedulesProviderException.getMessageKey(), schedulesProviderException.getArguments());
        } else {
